...
class TestUtils(unittest.TestCase):
    ...
    def test_compute_traitors_game_metrics(self, mock_read_csv):
        ...
        mock_df = pd.DataFrame({
            ...
            'Vote_Type': ['General', 'General', 'General', 'General', 'Traitor', 
                          'General', 'General', 'General', 'Traitor'],
            'Player_ID': [0, 1, 2, 3, 2, 0, 1, 3, 2],
            'Role': ['Faithful', 'Faithful', 'Traitor', 'Faithful', 'Traitor', 
                     'Faithful', 'Faithful', 'Faithful', 'Traitor'],
